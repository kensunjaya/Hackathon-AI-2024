    ...
    <SafeAreaView className="bg-primary h-full flex-1">
      <View className="w-full justify-center items-center mt-6 mb-6 px-4">
        ...
        <View className="flex items-end">
          <TouchableOpacity
            className="px-3 w-full h-16 flex flex-row justify-center items-center"
            onPress={editProfile}
          >
      ...
      <TouchableOpacity
        className="w-full h-16 flex px-5 border border-bluesk"
        onPress={() => {
          router.push("/changepassword");
        }}
      >
        <View className="flex-row items-center w-full h-full flex">
          <Image source={icons.lock} className="w-6 h-6" resizeMode="contain" />
          <Text className="font-pregular text-lg pl-5 text-gray-500">
            Ubah Kata Sandi
          </Text>
        </View>
      </TouchableOpacity>
